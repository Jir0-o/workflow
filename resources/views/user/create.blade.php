                ...
                <form class="p-5 lg:max-w-4xl mx-auto dropzone" action="{{ route('users.store') }}" method="POST">
                    <div class="flex gap-6 flex-wrap md:flex-nowrap">
                        <div class="w-1/2 mx-auto">
                            ...
                            <div class="mb-6">
                                <label for="roles" class="block mb-2 text-sm font-medium text-gray-900">Select Role</label>
                                <select multiple="multiple" name="roles[]" id="roles" class="multiple-select bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
